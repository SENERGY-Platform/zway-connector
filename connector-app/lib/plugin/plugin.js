...
SenergyConnector.prototype.run = function (config) {
    ...
    if(DEV){
        ...
        that.provisioning = Modules.include("provisioning").init(that.controller, deviceManagerUrl, authUrl, user, password, config.multi_gateway, config.multi_gateway_device_management);
