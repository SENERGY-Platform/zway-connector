        ...
        init: function (controller, physicalDevices) {
            var mapping = {
                ...
                /*
                    ...
                    if instance != 0
                    localServiceId = command + ":" + sub.command_class_id + "-" + sub.id + "-" + vDev_rest + ":" + sub.instance
                                    e.g. "exact:113-7-3-A:1"
                */
                getVirtualDevice: function (localDeviceId, localServiceId) {
                    ...
                    var instance;
                    var commandClassLocation;
                    if(localServiceIdParts.length > 2){
                        commandClassLocation = localServiceIdParts[1];
                        instance = localServiceIdParts[2];
                    }else{
                        commandClassLocation = localServiceIdParts[1];
                        instance = "0";
                    }
                    var suffix = [nodeId, instance, commandClassLocation].join("-"); //
                ...
                getLocalServiceId: function(instance, controllerAddress, command){
                    if(!instance || instance == "" || instance == "0" || instance == 0){
                        return command + ":" + controllerAddress;
                    }else{
                        return command + ":" + controllerAddress+":"+instance;
                    }
                },
                ...
                getServiceDescriptions: function(rawDevices, vDevOrig){
                    ...
                    switch(deviceType.toLowerCase()){
                        ...
                        case "battery".toLowerCase():
                            var getLevel = mapping.getLocalServiceId(vDevInfo.instance, vDevInfo.controller_address, "get_level");
                        ...
                        case "doorlock".toLowerCase():
                            ...
                            var open = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "open");
                            ...
                            var close = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "close");
                        ...
                        case "thermostat".toLowerCase():
                            ...
                            var exact = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "exact");
                        ...
                        case "toggleButton".toLowerCase():
                            ...
                            var on = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "on");
                        ...
                        case "switchBinary".toLowerCase():
                            ...
                            var on = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "on");
                            result.push({type: vDev.deviceType, vDevId: vDev.id, commandClass: service.command_class_name, localId: on, info: service.scale_info});
                            var off = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "off");
                            ...
                            var update = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "update");
                        ...
                        case "switchControl".toLowerCase():
                            ...
                            var off = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "off");
                            result.push({type: vDev.deviceType, vDevId: vDev.id, commandClass: service.command_class_name, localId: off, info: service.scale_info});
                            var upstart = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "upstart");
                            ...
                            var upstop = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "upstop");
                            ...
                            var downstart = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "downstart");
                            ...
                            var downstop = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "downstop");
                        ...
                        case "switchRGB".toLowerCase():
                            var getLevel = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "get_level");
                            result.push({type: vDev.deviceType, vDevId: vDev.id, commandClass: service.command_class_name, localId: getLevel, info: service.scale_info, outputExample:{level: "unknown-type", updateTime:"date and time as string"}});
                            var getColor = mapping.getLocalServiceId(vDevInfo.instance,vDevInfo.controller_address, "get_color");
