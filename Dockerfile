...
RUN apt-get update && apt-get -y install wget sharutils tzdata gawk libc-ares2 libavahi-compat-libdnssd-dev libarchive-dev unzip python iproute2 libcurl4-openssl-dev zlib1g-dev libc-ares-dev libv8-dev procps
